...
const Modal = ({ children }) => {
    ...
    return (
        <div onClick={closeModal} className="h-screen w-screen fixed z-50 bg-background bg-opacity-85 flex justify-center items-center">
            <Card onClick={(e) => e.stopPropagation()} className="w-[32rem] bg-surface1 relative">
                <SmallButton onClick={closeModal} className="absolute top-3 right-3 bg-surface3 hover:bg-hover">
